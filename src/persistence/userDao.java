...
public class userDao {
    ...
    public int  insertUser(User user) {
        ...
        if (ifUsernameExit) {
            ...
            try {
                ifInsertSuccess = dbmanager.insertInfor(user, hashedPassword, salt);
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
            if (ifInsertSuccess) {
    ...
    public User getUser(String username) throws SQLException {
        ...
        user=dbmanager.getInfByUsername(username);
        return user;
    }

    public boolean ifNameExit(String username) throws SQLException {
        return dbmanager.ifNameExit(username);
    }
}
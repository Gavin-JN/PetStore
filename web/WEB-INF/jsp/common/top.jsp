...
<head>
    ...
    <link rel="StyleSheet" href="css/mypetstore.css?v=2.14" type="text/css" media="screen" />
</head>
...
<div id="Header">
    ...
    <div id="Menu">
        <div id="MenuContent">
            ...
            <a href="cartForm" class="cartImage">
                <img align="middle" name="img_cart" src="images/cart.gif" />
                <div class="tips"><p id="num">${sessionScope.tips}</p></div>
            </a>
    ...
    <div id="Search">
        <div id="SearchContent">
           <form action="search" method="post">
              <input type="text" name="keyword" size="14" id="search_text">
